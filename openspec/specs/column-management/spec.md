...
The system SHALL allow users to add a new column to a board.

#### Scenario: User adds a column
- **WHEN** user selects "Add Column" and provides a column title
- **THEN** a new column is appended to the board layout
